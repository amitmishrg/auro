...
import { Check, ChevronsUpDown, Globe, Layers, AlignLeft } from 'lucide-react';
import { AudioLines, FolderOpen, X, FileAudio, Upload } from 'lucide-react';
import { Play, Pause, Mic, Tag } from 'lucide-react';
        ...
        <form.Field name="description">
          {(field) => {
            ...
            return (
              <Field data-invalid={isInvalid}>
                <div className="relative flex items-center">
                  <div className="pointer-events-none absolute left-0 flex h-full py-3 w-11 justify-center">
